...
class Client:
    ...
    def get_demons(limit=50, name="", name_contains="", after=0, before=0, verifier_id=0, publisher_id=0,
        ...
        Args:
            ...
            name_contains: Check if a demon has the specified string in his name, not case sensitive so it's a good alternative to name filter.
            after: Used for pagination, here is an example:
                    ...
                    limit = 100 AND after = 100: You will get the levels from position 101 to 200 because it will skip the 100 first ones.
        ...
        Returns:
            list: List of objects containing all demons information.
          """
